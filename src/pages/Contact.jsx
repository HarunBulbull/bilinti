    ...
    return (
        <Spin spinning={loading} tip="Gönderiliyor..." indicator={<LoadingOutlined spin />} size="large">
            ...
            <Helmet>
                ...
                <meta name="keywords" content="haber, bil, araştır, iletişim, bize ulaşın" />
                <link rel="canonical" href="https://www.bilintihaber.com/iletisim" />
            </Helmet>
