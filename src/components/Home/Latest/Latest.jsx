        ...
        <Spin spinning={loading} tip="Yükleniyor..." indicator={<LoadingOutlined spin />} size="large">
            <div className="flex flex-col gap-4 w-full">
                <div className="flex justify-between items-center">
                    ...
                    <Link to='/son-dakika' style={{ color: "black" }} className="flex items-center gap-2 opacity-70 transition duration:300 hover:opacity-100">Tüm Son Dakika Haberleri <ArrowUpRight /></Link>
                </div>
                <Swiper
                    grabCursor={true}
                    slidesPerView={4.5}
