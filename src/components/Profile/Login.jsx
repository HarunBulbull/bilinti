                    ...
                    >
                        ...
                        {section === "Kayıt Ol" && (
                            <>
                                ...
                                >
                                    <Checkbox>
                                        <Link to="/kullanim-sartlari" target="_blank">Kullanım Şartlarını</Link>,{" "}
                                        <Link to="/gizlilik-politikasi" target="_blank">Gizlilik Politikasını</Link> ve{" "}
                                        <Link to="/cerez-politikasi" target="_blank">Çerez Politikasını</Link> okudum ve kabul ediyorum.
                                    </Checkbox>
                                </Form.Item>
                                ...
                                >
                                    <Checkbox>
                                        <Link to="/kvkk" target="_blank">KVKK metnini</Link> okudum ve kabul ediyorum.
                                    </Checkbox>
                                </Form.Item>
                            </>
                        )}
